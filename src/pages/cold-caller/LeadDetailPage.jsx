...
// Mirrors CALLER_EDITABLE in leads.service.js.
...
export default function ColdCallerLeadDetailPage() {
  const { id } = useParams()
  ...
  return (
    <LeadDetailScreen
      lead={lead}
      onBack={() => navigate('/cold-caller/leads')}
      onDeleted={() => navigate('/cold-caller/leads')}
