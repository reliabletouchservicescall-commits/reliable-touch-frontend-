  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center px-4">
      <div className="w-16 h-16 rounded-2xl bg-[#3B82F6]/10 flex items-center justify-center mb-4">
        <Bell className="w-8 h-8 text-[#3B82F6]" strokeWidth={1.5} />
      </div>
      ...
      <p className="text-sm text-[#6B7280] dark:text-[#A1A1AA] max-w-xs">
        {unreadOnly
          ...
          : "New leads, appointment reminders, and status updates will show up here."}
      </p>
    </div>
  )
}
...
export default function ColdCallerNotificationsPage() {
